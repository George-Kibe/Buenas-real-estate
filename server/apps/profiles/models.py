...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=25, default="+254712345678")
    ...
    country = CountryField(verbose_name=_("Country"), default="Kenya", blank=False, null=False)
